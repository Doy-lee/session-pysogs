...
; Path to the x25519 private key file. This is a 64-byte file containing the raw private key data.
; A new key is generated by default if a key is not found at this location.
key_file = emoji_captcha_x25519
...
def entry_point(ini_path: str = 'emoji_captcha.ini'):
    ...
    key_file:          str        = parsed_ini.get   ('plugin_emoji_captcha', 'key_file',          fallback="emoji_captcha_x25519")
